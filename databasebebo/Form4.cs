...
namespace databasebebo
{
    public partial class Form4 : Form
    {
        ...
        public Form4(int projectID)
        {
            ...
            while (dr.Read())
            {
                lst1.Add(new GanttChart.BarInformation("Planned " + dr["NAME"].ToString(), DateTime.Parse(dr["STARTDATE"].ToString()),
                DateTime.Parse(dr["ENDDATE"].ToString()), colors[i], Color.Khaki, j++));
                lst1.Add(new GanttChart.BarInformation("Actual " + dr["NAME"].ToString(), DateTime.Parse(dr["STARTDATE"].ToString()),
                DateTime.Parse(dr["ACTUALENDDATE"].ToString()), colors[i], Color.Khaki, j++));
                i++;
                i %= 5;
            }
